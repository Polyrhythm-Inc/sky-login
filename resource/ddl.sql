...
CREATE TABLE IF NOT EXISTS `user_devices` (
  ...
  `device_id_dec` bigint(20) unsigned NOT NULL,
  ...
  `modified` datetime DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`),
  UNIQUE KEY `os_type_id_device_id` (`os_type_id`,`device_id`),
  UNIQUE KEY `os_type_id_device_id_dec` (`os_type_id`,`device_id_dec`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
